...
PROTECTED_INVARIANTS = [
    ...
    },
    {
        ...
        "forbidden_patterns": [
            ...
            r"read.{0,20}(amount|currency|rupees?).{0,20}one\s*digit\s*at\s*a\s*time",
        ],
    ...
    },
    {
        ...
        "forbidden_patterns": [r"digit[\s-]?by[\s-]?digit"],
        "must_contain_any": [r"natural|spoken|word"],
    ...
    },
    {
        ...
        "forbidden_patterns": [],
        "must_contain_any": [r"weekday|day\s*of\s*the\s*week"],
